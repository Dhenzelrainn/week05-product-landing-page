...
| Section | Preview |
|---|---|
| Desktop View | ![Desktop View](screenshots/desktop-view.png) |
...
| Hero Section | ![Hero Section](screenshots/hero-section.png) |
| Features Section | ![Features Section](screenshots/features-section.png) |
| Pricing / Packages Section | ![Pricing Section](screenshots/pricing-section.png) |
| Testimonials | ![Testimonials](screenshots/testimonials.png) |
| Footer | ![Footer](screenshots/footer.png) |
| VS Code Project Structure | ![Project Structure](screenshots/project-structure.png) |
| Blade Components Folder | ![Blade Components Folder](screenshots/blade-components-folder.png) |
...
| # | Problem | Solution |
|---|---|---|
| 1 | **Keeping the design responsive** — some layouts looked correct on desktop but became crowded on smaller screens. | Used responsive Tailwind breakpoints, flexible widths, Flexbox, and Grid layouts so sections could reorganize properly on tablets and mobile phones. |
| 2 | **Repeated interface code** — repeating the same card or button markup made the project harder to maintain. | Used reusable Blade Components for repeated UI elements such as buttons, feature cards, pricing cards, testimonials, navigation, and the footer. |
| 3 | **Maintaining consistent styling** — different sections looked disconnected when spacing, button styles, card radius, and typography were inconsistent. | Used shared Tailwind utility patterns and reusable components to keep the design consistent. |
| 4 | **Organizing project assets** — images and screenshots became difficult to manage when stored in random locations. | Kept website assets inside `public`, project screenshots inside `screenshots`, and before-and-after images inside `documentation`. |
...
**Repository:** https://github.com/Dhenzelrainn/week05-product-landing-page
